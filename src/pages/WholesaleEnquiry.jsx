...
{numSelected > 0 ? (
        ...
        (<Typography
          ...
          component="div"
        >
          {`All Wholesale  (${props.orderCount})` }
        </Typography>
      )
        } 
      ...
      >
         <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.setOpenDeleteConfimModal(true)} >
          ...
          <ListItemText primary="Delete Enquiries"  primaryTypographyProps={{ variant: 'body2' }} />
        </MenuItem>
...
export default function EnhancedTable() {
  ...
  const [ openWholesaleEnquiryPreview, setOpenWholesaleEnquiryPreview] = useState(false);
  const [isOpen, setIsOpen] = useState(false);
  const [isOpen2, setIsOpen2] = useState(false);
...
const handleDleteOrders = async(value)=>{
  ...
  setRender(prev=>!prev)
 if(res?.data?.status){
  setMessage((prev)=>({...prev,type:"success",message:"Enquiries Deleted Successfully !"}))
...
//############################# CLOSE DELETE CONFIM MODAL FUNCTION #############################
  ...
  return (
    ...
    <WholesaleEnquiryPreview open={openWholesaleEnquiryPreview} handleClose={handleCloseWholesaleEnquiryPreview}  />
   ...
   <TextField id="outlined-basic" type="search" value={search} onChange={(e)=>setSearch(e.target.value)} fullWidth  label="Search In Enquiries" placeholder='Search Anything...' variant="outlined"  InputProps={{
          startAdornment: (
...
<Paper elevation={3} sx={{ width: '100%', mb: 2 }}>
                ...
                ?.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">+91-87990098987 </TableCell>
                      {/* <TableCell align="center" style={{textTransform:'capitalize'}} >{row.customer_name}</TableCell> */}
                      <TableCell align="center" style={{textTransform:'capitalize'}} >DOC00021</TableCell>
                      {/* <TableCell align="right">{row.fat}</TableCell> */}
                      {/* <TableCell align="right">{row.protein}</TableCell> */}
                      <TableCell align="center"> Dr. Ramesh Singh </TableCell>
      ...
      >
        ...
        <MenuItem value={30}>Cancel</MenuItem>
                      ...
                      <VisibilityIcon style={{cursor:'pointer'}} fontSize='small' onClick={()=>setOpenWholesaleEnquiryPreview(true)} />
                        </TableCell>
                    </TableRow>
                  );
                })}
