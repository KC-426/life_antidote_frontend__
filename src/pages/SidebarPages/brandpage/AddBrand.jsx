...
function AddBrand({ handleClose }) {
  ...
  const handleRemoveMainCategoryImage = async (
    ...
    await axios
      .patch(
        `${process.env.REACT_APP_BACKEND_URL}/api/delete/main/category/image/?old_main_category_name=${userselectedCategory?.main_Catgeory}`,
        { withCredentials: true }
      )
      .then((res) => {
        console.log(res);
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch(
        `${process.env.REACT_APP_BACKEND_URL}/api/update/all/main/category/?old_main_category_name=${userselectedCategory?.main_Catgeory}`,
        { ...data },
        { withCredentials: true }
      )
      .then((res) => {
