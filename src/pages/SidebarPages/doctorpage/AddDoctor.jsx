    ...
    const handleSubmit = async(e)=>{
      ...
      if(fileUpload.length > 0){
        for(let i = 0; i<fileUpload?.length;i++){
          productsImageToFirebase[i]= await uploadFileToFirebase(`/${process.env.REACT_APP_IMAGES_FOLDER_NAME}/products/${productData?.doctor_code}/`,fileUpload[i]);
     ...
     await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/add/new/product`,{...productData,product_images:productsImageToFirebase},{withCredential:true})
      .then(res=>{
          console.log(res)
          setLoading(false);
          setMessage((prev)=>({...prev,type:'success',message:'Doctor Added Successfully !!'}))
            ...
            <div className='addproduct_img_and_details flex'>
             ...
             <CancelIcon style={{color:'red',cursor:'pointer'}}  onClick={()=>handleRemoveImage(index)} />
                ...
                <div className='add_product_form'>
                    ...
                    <TextField required fullWidth className='product_form_input' id="outlined-basic" name="doctor_code" value={productData?.doctor_code} onChange={handleChange} placeholder=" Doctor Code " variant="outlined" />
                    </div>

                    <div className='add_product_label_input'>
                    <label htmlFor=""> Doctor Name  </label>
                    <TextField required fullWidth className='product_form_input' id="outlined-basic" name="doctor_name" value={productData?.doctor_name} onChange={handleChange} placeholder=" Doctor Name " variant="outlined" />
                    </div>
                    <div className='add_product_label_input'>
                    <label htmlFor=""> Doctor Specilization  </label>
                    <TextField required fullWidth className='product_form_input' id="outlined-basic" name="doctor_specilization" value={productData?.doctor_specilization} onChange={handleChange} placeholder=" Doctor Specilization" variant="outlined" />
                    </div>
                    <div className='add_product_label_input'>
                    <label htmlFor=""> Doctor Experience  </label>
                    <TextField required fullWidth className='product_form_input' id="outlined-basic" name="doctor_experience" value={productData?.doctor_experience} onChange={handleChange} placeholder=" Doctor Experience" variant="outlined" />
                    </div>
                    <div className='add_product_label_input'>
                    <label htmlFor=""> Doctor Timing  </label>
                    <TextField required fullWidth className='product_form_input' id="outlined-basic" name="doctor_timing" value={productData?.doctor_timing} onChange={handleChange} placeholder=" Doctor Timing" variant="outlined" />
                    </div>
                  ...
                  <div className='add_product_label_input' style={{width:'100%'}} >
                    ...
                    <TextField multiline rows={5}  fullWidth className='product_form_input' name='doctor_description' value={productData?.doctor_description} onChange={handleChange} id="outlined-basic" placeholder=" Add Description " variant="outlined" />
                    </div>
