...
{numSelected > 0 ? (
      ...
      >
         <MenuItem sx={{ color: 'text.secondary' }} onClick={()=>props.setOpenDeleteConfimModal(true)} >
          ...
          <ListItemText primary="Delete Doctor"  primaryTypographyProps={{ variant: 'body2' }} />
        </MenuItem>
...
// add doctor 
  ...
  return (
    ...
    <div className='product-topbar-box vendor-topbar-box ' >
      ...
      <div className='product-topbar-btn' >
          ...
          <SideDrawer state={drawerAddProduct} toggleDrawerClose={handleCloseAddProductSideBar} toggleDrawerOpen={handleOpenAddProductSidebar}
           ComponentData={<AddDoctor handleClose={handleCloseAddProductSideBar} />}
   ...
   <TextField id="outlined-basic" type="search" value={search} onChange={(e)=>setSearch(e.target.value)} fullWidth  label="Search In Doctors" placeholder='Search Anything...' variant="outlined"  InputProps={{
          startAdornment: (
   ...
   <Button sx={{ml:2,height:54,px:5}} variant="contained" type='submit'>
        Search
      </Button>
   </form>
                ...
                ?.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div  >
                        <img className='product-table-image' alt="product" src='https://cdn2.vectorstock.com/i/1000x1000/32/51/women-doctor-icon-vector-38223251.jpg' />
                      ...
                      <TableCell align="center" style={{textTransform:'capitalize'}} >Heart Surgeon</TableCell>
                      {/* <TableCell align="right">{row.fat}</TableCell> */}
                      {/* <TableCell align="right">{row.protein}</TableCell> */}
                      <TableCell align="center"> <p  >{row.products?.length} Year</p> </TableCell>
